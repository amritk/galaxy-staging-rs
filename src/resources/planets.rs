...
pub struct PlanetsResource {
    client: crate::client::DemoApiScalarGalaxyClient,
}

impl PlanetsResource {
    pub(crate) fn new(client: crate::client::DemoApiScalarGalaxyClient) -> Self {
        Self { client }
    }
    ...
    pub fn upload_image(&self, planet_id: i64) -> UploadImageRequestBuilder {
        UploadImageRequestBuilder::new(self.client.clone(), planet_id)
    }
}
...
impl ListRequestBuilder {
    fn new(client: crate::client::DemoApiScalarGalaxyClient) -> Self {
        Self {
            client,
            limit: None,
            offset: None,
    ...
    pub async fn send(self) -> Result<crate::models::PlanetsListResponse, crate::error::Error> {
        ...
        self.client
            .send::<crate::models::PlanetsListResponse, _>(
                http::Method::GET,
                &path,
                &query,
                &headers,
...
impl RetrieveRequestBuilder {
    fn new(client: crate::client::DemoApiScalarGalaxyClient, planet_id: i64) -> Self {
        Self {
            client,
            planet_id,
            timeout: None,
